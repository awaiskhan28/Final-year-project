            ...
            <section class="team section-padding">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h2 class="mb-5">Class<span>work</span></h2> 
                        </div>                   
...
<div class="container">
  <div style="background:ghostwhite;" class="row align-items-start">
    <div  class="col">
    <br>
      <center><b>Class notes</b></center>
      <br>
                              <?php
                            // Retrieve data from the database
                            $query = "SELECT * FROM academic_record where course='server' and type='notes' ORDER BY date DESC";
    ...
    <div class="col">
    <br>
      <center><b>Assignments</b></center>
      <br>
      <?php
// Retrieve data from the database
 $query = "SELECT * FROM objective where (course='server'  and completed=0  and  s_id ='$user') or (course='server'  and completed=0  and  s_id =0) ORDER BY duedate ASC limit 10";
$result = mysqli_query($conn, $query);
// if (!$result) {
