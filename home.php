...
<script>
  $(document).ready(function(){
      ...
      $("#searchText").on("input", function(){
         ...
         if(searchText == "") return; // If the search text is empty, return
         $.post('app/ajax/search.php', {
                key: searchText
             },
             function(data, status){
                  $("#chatList").html(data); // Update the chat list with the search results
             });
       });
      ...
      **/
      let lastSeenUpdate = function(){
        $.get("app/ajax/update_last_seen.php"); // Make a GET request to update the last seen status
      }
      lastSeenUpdate();
      ...
      **/
      setInterval(lastSeenUpdate, 10000); // Call the lastSeenUpdate function every 10 seconds
