                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="col-lg-4 mb-4 col-12">
                                <a href="server.php" class="team-link">
                                    <div class="team-thumb d-flex align-items-center">
                                        <img src="images/assets/dash1.png" class="img-fluid custom-circle-image team-image me-4" alt="">
                                        <div class="team-info">
                            ...
                            <div class="col-lg-4 mb-4 col-12">
                                <a href="course.php" class="team-link">
                                    <div class="team-thumb d-flex align-items-center">
                                        <img src="images/assets/dash2.png" class="img-fluid custom-circle-image team-image me-4" alt="">
                                        <div class="team-info">
                            ...
                            <div class="col-lg-4 mb-4 col-12">
                                <a href="course.php" class="team-link">
                                    <div class="team-thumb d-flex align-items-center">
                                        <img src="images/assets/dash3.png" class="img-fluid custom-circle-image team-image me-4" alt="">
                                        <div class="team-info">
                                            <h5 class="mb-0">Bsc</h5>                                
                                        </div>
                                    </div>
                                    <div class="team-overlay"></div>
                                </a>
                            ...
                            <div class="col-lg-4 mb-4 col-12">
                                <a href="course.php" class="team-link">
                                    <div class="team-thumb d-flex align-items-center">
                                        <img src="images/assets/dash4.png" class="img-fluid custom-circle-image team-image me-4" alt="">
                                        <div class="team-info">
                            ...
                            <div class="col-lg-4 mb-4 col-12">
                                <a href="course.php" class="team-link">
                                    <div class="team-thumb d-flex align-items-center">
                                        <img src="images/assets/dash5.png" class="img-fluid custom-circle-image team-image me-4" alt="">
                                        <div class="team-info">
                                            <h5 class="mb-0">AI</h5>                                
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 mb-4 col-12">
                                <a href="course.php" class="team-link">
                                    <div class="team-thumb d-flex align-items-center">
                                        <img src="images/assets/asset6.png" class="img-fluid custom-circle-image team-image me-4" alt="">
                                        <div class="team-info">
...
// Retrieve data from the database
 $query = "SELECT * FROM objective where completed=0 ORDER BY duedate ASC limit 6";
