            ...
            <section class="team section-padding">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h2 class="mb-5">DEAD<span>LINE</span></h2> 
                        </div>                   
            
                <br>

<div style="" class="container">
  <div style="background:white;" class="row align-items-start">
    <div style="padding-right:80px;" class="col">
    <br>
      <center><b>Critical deadlines</b></center>
      <br>
                   <?php
// Retrieve data from the database
 $query = "SELECT * FROM objective where (course='server' and type='critical' and completed='0' and s_id ='$user') or (course='server' and completed=0 and s_id ='0' and type='critical')  ORDER BY duedate ASC";
...
if (mysqli_num_rows($result) > 0)
 {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<a class="btn-download" href="complete.php?idl=' . $row['obj_id'] . '">Complete</a>';
        echo '</div>';
...
?>
    ...
    <div class="col">
    <br>
      <center><b>Non-critical deadlines</b></center>
      <br>
           <?php
// Retrieve data from the database
$query = "SELECT * FROM objective where (course='server' and type='Non-critical' and completed=0 and s_id ='$user') or (course='server' and completed=0 and s_id =0 and type='Non-critical')  ORDER BY duedate ASC"; 
$result = mysqli_query($conn, $query);
// if (!$result) {
//     die('Error in query: ' . mysqli_error($conn));
// }
