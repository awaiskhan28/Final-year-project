            ...
            <section class="team section-padding">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h2 class="mb-5">REC<span>ORDS</span></h2> 
                        </div>                   
            
                <br>
                <br>
			     <div class="container">
			      <form action="academicRecord_include.php" method="post" enctype="multipart/form-data">
                  ...
                  <h2 class="text">Saved<span>Record</span></h2>
                    ...
                    <div class="row">
                        ...
                        <br>
						  <?php
							...
							$query = "SELECT * FROM academic_record WHERE s_id = $user ORDER BY date DESC";
