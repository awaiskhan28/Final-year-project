            ...
            <section class="team section-padding">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h2 class="mb-5">Object<span>ives</span></h2> 
                        </div>                   
            
                <br>
                <br>
           <div class="container">
            <form action="serverObjectiveInclude.php" method="post" enctype="multipart/form-data">
              ...
              <button type="submit" name="submit" class="btn">Submit</button>
                  ...
                  <h2 class="text">Upcoming<span>Objectives</span></h2>
...
// Retrieve data from the database
 $query = "SELECT * FROM objective where course='server' and s_id ='$user' and completed=0  ORDER BY duedate ASC";
